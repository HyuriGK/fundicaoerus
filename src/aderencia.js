...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        console.error("Erro GET Aderência:", error);
...
// --- ROTA POST: Salvar, Atualizar e Deletar ---
router.post('/', async (req, res) => {
    ...
    try {
        ...
        // 2. Atualizar apenas o Realizado (Edição rápida na tabela)
        ...
        console.error("Erro POST Aderência:", error);
        res.status(500).json({ error: error.message });
    } finally {
        client.release();
    }
