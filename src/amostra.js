...
// ==================================================================
// 1. SALVAR (POST /api/amostra/save_all)
// ==================================================================
router.post('/save_all', async (req, res) => {
    ...
    try {
        ...
        console.error("Erro API Amostra Save:", e);
...
// ==================================================================
// 2. CARREGAR (GET /api/amostra/load_all)
// ==================================================================
router.get('/load_all', async (req, res) => {
    const client = await pool.connect();
    ...
    try {
        ...
        console.error("Erro API Amostra Load:", e);
        res.status(500).json({ error: e.message });
    } finally {
        client.release();
    }
...
// ==================================================================
// 3. LIMPAR (POST /api/amostra/clear_monitor)
// ==================================================================
router.post('/clear_monitor', async (req, res) => {
    const client = await pool.connect();
    ...
    try {
        ...
        await client.query('ROLLBACK');
        console.error("Erro API Amostra Clear:", e);
        res.status(500).json({ error: e.message });
    } finally {
        client.release();
    }
