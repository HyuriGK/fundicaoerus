...
router.get('/', async (req, res) => {
    try {
        ...
        const fornoFilter = req.query.forno ? ` AND TRIM(c.forno_cor) = $3` : '';
        if (req.query.forno) params.push(req.query.forno.trim());
        ...
        for (const row of result.rows) {
            ...
            corridaMap[key].itens.push({
                ...
                tem_ficha:             !!row.qtde_caixas_macho || !!row.detalhes_machos || !!row.detalhes_luvas,
