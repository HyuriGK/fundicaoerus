    ...
    try {
        ...
        await pool.query(`
            CREATE TABLE industrial_snapshots (
                ...
                moldagem_pesada_qty NUMERIC DEFAULT 0,
                moldagem_pesada_weight NUMERIC DEFAULT 0,
                moldagem_pesada_value NUMERIC DEFAULT 0,
                moldagem_leve_qty NUMERIC DEFAULT 0,
                moldagem_leve_weight NUMERIC DEFAULT 0,
                moldagem_leve_value NUMERIC DEFAULT 0,
                moldagem_manual_qty NUMERIC DEFAULT 0,
                moldagem_manual_weight NUMERIC DEFAULT 0,
                moldagem_manual_value NUMERIC DEFAULT 0,
                fechamento_manual_qty NUMERIC DEFAULT 0,
                fechamento_manual_weight NUMERIC DEFAULT 0,
                fechamento_manual_value NUMERIC DEFAULT 0,
                moldagem_outros_qty NUMERIC DEFAULT 0,
                moldagem_outros_weight NUMERIC DEFAULT 0,
                moldagem_outros_value NUMERIC DEFAULT 0,
