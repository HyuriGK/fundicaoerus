    ...
    try {
        ...
        const query = `
            SELECT 
                ...
                P.QUANTIDADE_PPR, P.FATURADO_PPR, P.QUANTIDADE_FATURADA_PPR, P.QUANTIDADE_DESISTENCIA_PPR, P.PESO_LIQUIDO_NPR, P.EMPRESA_PPR, P.ANO_PPR, P.ITEM_PPR, P.ORDEM_COMPRA_PPR,
