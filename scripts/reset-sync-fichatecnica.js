        ...
        Firebird.attach(firebirdOptions, function (err, db) {
            ...
            const sql = `
                SELECT 
                    ...
                    (SELECT FIRST 1 FTT.FOTO_FTT FROM FICHA_TECNICA_FOTO FTT 
                     WHERE FTT.FIC_CODIGO_FTT = F.CODIGO_FIC 
                     AND FTT.EXIBIR_RELATORIO_FTT = 'S' 
                     ORDER BY FTT.ORDEM_FTT ASC) as FOTO_FTT
