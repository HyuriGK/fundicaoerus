    ...
    Firebird.attach(firebirdOptions, function (err, db) {
        ...
        const sql = `
            SELECT 
                ...
                F.TIPO_MOLDAGEM_DESC_FIC, F.OPERACAO_MOLDAGEM_DESC_FIC, F.DESENHO_INT_DATA_REV_FIC,
                ...
                F.PESO_UNITARIO_SEM_ALIMENT_FIC, F.RELACAO_MOLDE_METAL_FIC, F.RELACAO_METAL_MOLDE_FIC,
                F.PESO_TAMPA_FIC, F.PESO_FUNDO_FIC, F.CAVIDADE_QTDE_FIGURAS_FIC, F.TIPO_MODELO_FIC,
                P.NOME_PRO, P.PESO_LIQUIDO_PRO, P.PESO_BRUTO_PRO, P.UNIDADE_PRO, P.NCM_PRO, P.SITUACAO_PRO,
        ...
        db.query(sql, async function (err, results) {
            ...
            for (const row of results) {
                try {
                    ...
                    const relacao = row.RELACAO_MOLDE_METAL_FIC || row.RELACAO_METAL_MOLDE_FIC || 0;
                    ...
                    await client.query(`
                        INSERT INTO ficha_tecnica (
                            ...
                            ncm_pro, situacao_pro, cliente_nome, cli_codigo_fic, cli_codgio_fic,
                    ...
                    `, [
                        ...
                        row.TIPO_MOLDAGEM_DESC_FIC, row.OPERACAO_MOLDAGEM_DESC_FIC, row.DESENHO_INT_DATA_REV_FIC, row.DESCRICAO_FIC,
                        row.NOME_PRO, row.PESO_LIQUIDO_PRO, row.PESO_BRUTO_PRO, row.UNIDADE_PRO, row.NCM_PRO, row.SITUACAO_PRO,
