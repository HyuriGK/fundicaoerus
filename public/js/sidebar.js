(function() {
    ...
    style.textContent = [
        ...
        '#erus-sidebar .erus-nav-group-sep.active-group { background:rgba(63,63,70,0.2); }',
        // Footer
        ...
        '}',
        'body.erus-sidebar-collapsed #erus-sidebar .erus-nav-group-sep.active-group { background:rgba(63,63,70,0.25) !important; border-color:rgba(161,161,170,0.2) !important; }',
        ...
        '  body.erus-sidebar-collapsed #erus-sidebar .erus-nav-group-sep {',
        '    display:grid !important; grid-template-columns:24px max-content minmax(20px,1fr) 18px !important;',
        '    align-items:center !important; justify-content:stretch !important; column-gap:8px !important;',
        '    padding:4px 10px !important; margin:16px 0 6px !important;',
        '    width:auto !important; height:auto !important; background:transparent !important; border:0 !important;',
        '  }',
        '  body.erus-sidebar-collapsed #erus-sidebar .erus-nav-group-sep i:first-child { width:24px !important; margin:0 !important; text-align:center !important; }',
        ...
        '  body.erus-sidebar-collapsed #erus-sidebar .erus-nav-group-sep .fa-plus,',
        '  body.erus-sidebar-collapsed #erus-sidebar .erus-nav-group-sep .fa-minus { width:18px !important; margin:0 !important; text-align:center !important; }',
